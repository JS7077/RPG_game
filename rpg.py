...
c = ',nbv'#constant unless player says so
m = 100#money
...
def tavern():
    ...
    if a == '1':
        print(player_name + ':"Drink please."')
        a = query('(1)Mead($5), (2)Cider($5), (3)Wine($10), or (4)Beer($10)?', ['1', '2', '3', '4'])
        if a == '1':
            psay('Mead please.')
            money(5)
        ...
        print(player_name + ':"Nothing. Thank you."')
    if quest == 'Jerry':
...
def inn():
    ...
    if a == 'yes':
        ...
        if a == '1':
            say('I want a place to stay.', player_name)
            time.sleep(.5)
